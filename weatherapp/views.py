...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=e499f3cd53d3b0f34441f16742dcbf44'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyC-I1gFFifUyLIKWMjcRkOpwYF1DuqYo-E'

    SEARCH_ENGINE_ID = '24baf8ca65e394f7c' 
 

#     AIzaSyC-I1gFFifUyLIKWMjcRkOpwYF1DuqYo-E // api 
